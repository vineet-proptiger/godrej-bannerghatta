        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p className='text-justify' style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 20px' }}>
              Godrej Properties is one of India's most trusted and renowned real estate developers, backed by the 127-year legacy of the Godrej Group. Known for innovation, sustainability, and design excellence, Godrej Properties has delivered landmark residential, commercial, and township projects across 12+ cities including Bangalore, Mumbai, Pune, NCR, and Hyderabad. With over 50 million sq. ft. of space developed and a commitment to eco-friendly construction, every Godrej home reflects superior quality, transparency, and long-term value for homebuyers.
            </p>
