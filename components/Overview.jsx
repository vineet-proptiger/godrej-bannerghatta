...
const OVERVIEW_TEXT = `Godrej Bannerghatta Road offers premium 2 & 3 BHK apartments in a well-planned 36-acre gated community designed for modern urban living with smart layouts and comfortable spaces. Located on Bannerghatta Road, South Bangalore, it provides excellent connectivity to Electronic City, JP Nagar, BTM Layout, and NICE Road, along with easy access to leading schools, hospitals, and shopping hubs. Residents can enjoy a wide range of lifestyle amenities including a clubhouse, swimming pool, landscaped gardens, jogging tracks, kids' play area, indoor games, multipurpose hall, and 24/7 security. Pre-launch phase now open – enquire today for details.`
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex' }}>
            <div style={{
              ...
              border: '3px solid #fff', width: '100%', minHeight: '470px',
            }}>
              <Image src={overviewImage} alt="Godrej Bannerghatta" fill className="object-fit"
