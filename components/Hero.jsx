            ...
            >
              {slides.map((src, idx) => (
                <div key={idx} style={{ width: `${100 / slides.length}%`, flexShrink: 0, position: 'relative' }}>
                  <Image src={src} alt={`Godrej Bannerghatta ${idx + 1}`} fill className="object-cover"
          ...
          <div className="p-4 flex flex-col gap-3">
            ...
            <div style={{ textAlign: 'center', paddingBottom: '10px', borderBottom: '1px solid #f0f0f0' }}>
              ...
              <span style={{ fontSize: '1px', opacity: 0, position: 'absolute', pointerEvents: 'none', userSelect: 'none' }}>
                Godrej Bannerghatta New Launch Bannerghatta Road South Bangalore 2 3 4 BHK Luxury Apartments
              </span>
              <p style={{
                ...
                New Launch Godrej Bannerghatta Road
              </p>
            </div>
            ...
            <div style={{
              ...
              {[
                '36 Acres Integrated Township',
                'Grand 65,000+ sq. ft. clubhouse',
                'EOI Open: Starts From 8L*',
              ].map((tag, i) => (
                <p key={i} style={{
