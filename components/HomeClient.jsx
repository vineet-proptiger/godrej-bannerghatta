...
const Overview = dynamic(() => import('./Overview'), { ssr: true })
const Highlights = dynamic(() => import('./Highlights'), { ssr: true })
const Amenities = dynamic(() => import('./Amenities'), { ssr: true })
const Pricing = dynamic(() => import('./Pricing'), { ssr: true })
const Location = dynamic(() => import('./Location'), { ssr: true })
const MasterPlan = dynamic(() => import('./MasterPlan'), { ssr: true })
const AboutDeveloper = dynamic(() => import('./AboutDeveloper'), { ssr: true })
  ...
  return (
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar">
        ...
        <a
          href="https://wa.me/919718344024?text=Hi%20I%20am%20interested%20in%20Godrej%20Bannerghatta%2C%20Bangalore"
